// **Clasificación de calificaciones**: Solicita una calificación (0-100) y
// muestra si es "Aprobado", "Reprobado" o "Sobresaliente".

#include <stdio.h>
int main() {
  printf("\n Este programa mostrara si su calificacion es reprobatoria, "
         "aprobatoria o sobresaliente.\n");
